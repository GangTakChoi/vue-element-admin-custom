...
<script>
import PanThumb from '@/components/InitComponents/PanThumb'
import MdInput from '@/components/InitComponents/MDinput'
import Mallki from '@/components/InitComponents/TextHoverEffect/Mallki'
import DropdownMenu from '@/components/InitComponents/Share/DropdownMenu'
